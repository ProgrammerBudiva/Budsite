...
*/
     ...
     if(($currency_a!=$currency_a)&&($arr3->product[$i]->data->currency!='')){
                     ...
                     if(!empty($selattr1))
                     {
                         ...
                         if($attrname2==$arr3->product[$i]->attributes->attribute[$attrq]->attrname)
                         {
                             ...
                             if($testtext!=$arr3->product[$i]->attributes->attribute[$attrq]->attrvalue)
                             {
                                 ...
                                 {
                             $updtext=mysql_query("UPDATE oc_product_attribute SET text='".$arr3->product[$i]->attributes->attribute[$attrq]->attrvalue."'"." WHERE attribute_id=".$selattr1."AND product_id=".$prdid);
                                 }
                             }
                         }
