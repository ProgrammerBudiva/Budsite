...
*/
    ...
    /* $model_u=mysql_real_escape_string($arr3->product[$i]->data->model);
...
echo($prdid)."<br>".$model_u."<br>";
     if(!empty($prdid))
     {
         echo $arr3->product[$i]->main->image1."<br>";
         ...
         if($arr3->product[$i]->main->image2!='')
         {
             $im2=mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES ('',".$prdid.",'".$arr3->product[$i]->main->image2."',0,'slider'");
         }
         if($arr3->product[$i]->main->image3!='')
         {
             $im3=mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES ('',".$prdid.",'".$arr3->product[$i]->main->image3."',0,'slider'");
         }
         if($arr3->product[$i]->main->image4!='')
         {
             $im4=mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES ('',".$prdid.",'".$arr3->product[$i]->main->image4."',0,'slider'");
         }
         if($arr3->product[$i]->main->image5!='')
         {
             $im5=mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES ('',".$prdid.",'".$arr3->product[$i]->main->image5."',0,'slider'");
         }
         if($arr3->product[$i]->main->image6!='')
         {
             $im6=mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES ('',".$prdid.",'".$arr3->product[$i]->main->image6."',0,'slider'");
         }
         if($arr3->product[$i]->main->image7!='')
         {
             $im7=mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES ('',".$prdid.",'".$arr3->product[$i]->main->image7."',0,'slider'");
         }
         if($arr3->product[$i]->main->image8!='')
         {
             $im8=mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES ('',".$prdid.",'".$arr3->product[$i]->main->image8."',0,'slider'");
         }
         */
     }
     /*
       ...
       $u1="UPDATE oc_product SET base_price=".$price.", price=".$price.", base_currency_code='".$arr3->product[$i]->data->currency."'"." WHERE model = '".$model_u."'";
