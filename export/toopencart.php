...
//$i=0;
$trunc=mysql_query("TRUNCATE TABLE oc_product_image");
...
for( $q=0;$q<count($arr3->product[$i]->attributes->attribute);$q++ )
{
    ...
    if(!empty($pid)) {
        ...
        if ($arr3->product[$i]->main->image1 != '') {
            mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES (''," . $pid . ",'" . "catalog/" . $arr3->product[$i]->main->image1 . "'" . ",0,'main'" . ")") or die(mysql_error());
        }
        if ($arr3->product[$i]->main->image2 != '') {
            mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES (''," . $pid . ",'" . "catalog/" . $arr3->product[$i]->main->image2 . "'" . ",0,'main'" . ")") or die(mysql_error());
        }
        if ($arr3->product[$i]->main->image3 != '') {
            mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES (''," . $pid . ",'" . "catalog/" . $arr3->product[$i]->main->image3 . "'" . ",0,'main'" . ")") or die(mysql_error());
        }
        if ($arr3->product[$i]->main->image4 != '') {
            mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES (''," . $pid . ",'" . "catalog/" . $arr3->product[$i]->main->image4 . "'" . ",0,'main'" . ")") or die(mysql_error());
        }
        if ($arr3->product[$i]->main->image5 != '') {
            mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES (''," . $pid . ",'" . "catalog/" . $arr3->product[$i]->main->image5 . "'" . ",0,'main'" . ")") or die(mysql_error());
        }
        if ($arr3->product[$i]->main->image6 != '') {
            mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES (''," . $pid . ",'" . "catalog/" . $arr3->product[$i]->main->image6 . "'" . ",0,'main'" . ")") or die(mysql_error());
        }
        if ($arr3->product[$i]->main->image7 != '') {
            mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES (''," . $pid . ",'" . "catalog/" . $arr3->product[$i]->main->image7 . "'" . ",0,'main'" . ")") or die(mysql_error());
        }
        if ($arr3->product[$i]->main->image8 != '') {
            mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES (''," . $pid . ",'" . "catalog/" . $arr3->product[$i]->main->image8 . "'" . ",0,'main'" . ")") or die(mysql_error());
        }
    }
    /*
//===============color
