...
if(($modcnt<=0) && ($prodesccnt<=0) && ($tvidcount<=0)){ //товар не існує
    /*
 ...
 */
  ...
  //$u1="UPDATE oc_product SET base_price=".$price.", price=".$price.", base_currency_code='".$arr3->product[$i]->data->currency."'"." , quantity=".$quantity." WHERE model = '".$model_u."'";
     ...
     $tovar_update=mysql_query("SELECT price,base_currency_code,quantity,sku,image FROM oc_product WHERE tovarid = '".$tovarid_u."'");
...
if(($price_a!=(float)$arr3->product[$i]->data->price) || ($currency_a!=$currency_a) ||($quantity_a!=(int)$arr3->product[$i]->data->quantity ) || ($sku_a!=$arr3->product[$i]->main->articul) ||($image_a!=$imgpath))
{
 ...
 // ", price=".$price." , cost=".$cost.", base_price=".$arr3->product[$i]->data->price.", base_currency_code='".$arr3->product[$i]->data->currency."', weight=".$arr3->product[$i]->data->weight.", length=".$arr3->product[$i]->data->length.", width=".$arr3->product[$i]->data->width.", height=".$arr3->product[$i]->data->heigth.", minimum=0, sort_order=".$sort_order.", date_modified=".$arr3->product[$i]->data->date." WHERE model = '".$model_u."'";
       ...
       mysql_query($u1) or die(mysql_error());
         ...
         $meta_title=$name;
         if(!empty($prdid)) {
             $desc_upd=mysql_query("SELECT description FROM oc_product WHERE product_id=".$prdid);
...
/*
             ...
             $imgtst8=-1;
*/
             $imgtst1=mysql_query("SELECT product_image_id FROM oc_product_image WHERE product_id=".$prdid." AND image='"."catalog/".$arr3->product[$i]->main->image1."'");
             $imgtst2=mysql_query("SELECT product_image_id FROM oc_product_image WHERE product_id=".$prdid." AND image='"."catalog/".$arr3->product[$i]->main->image2."'");
             $imgtst3=mysql_query("SELECT product_image_id FROM oc_product_image WHERE product_id=".$prdid." AND image='"."catalog/".$arr3->product[$i]->main->image3."'");
             $imgtst4=mysql_query("SELECT product_image_id FROM oc_product_image WHERE product_id=".$prdid." AND image='"."catalog/".$arr3->product[$i]->main->image4."'");
             $imgtst5=mysql_query("SELECT product_image_id FROM oc_product_image WHERE product_id=".$prdid." AND image='"."catalog/".$arr3->product[$i]->main->image5."'");
             $imgtst6=mysql_query("SELECT product_image_id FROM oc_product_image WHERE product_id=".$prdid." AND image='"."catalog/".$arr3->product[$i]->main->image6."'");
             $imgtst7=mysql_query("SELECT product_image_id FROM oc_product_image WHERE product_id=".$prdid." AND image='"."catalog/".$arr3->product[$i]->main->image7."'");
             $imgtst8=mysql_query("SELECT product_image_id FROM oc_product_image WHERE product_id=".$prdid." AND image='"."catalog/".$arr3->product[$i]->main->image8."'");
             ...
             echo $prdid."|"."catalog/".$arr3->product[$i]->main->image1."<br>";
             echo $imgid1."<br>";

             if($arr3->product[$i]->main->image1!='')
               {
                  if(empty($imgid1)) {
                         mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES (''," . $prdid . ",'" . "catalog/" . $arr3->product[$i]->main->image1 . "'" . ",0,'main'" . ")") or die(mysql_error());
               }
             ...
             {
                 if(empty($imgid2)) {
                     mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES (''," . $prdid . ",'" . "catalog/" . $arr3->product[$i]->main->image2 . "'" . ",0,'main'" . ")") or die(mysql_error());
                 }
             ...
             {
                 if(empty($imgid3)) {
                     mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES (''," . $prdid . ",'" . "catalog/" . $arr3->product[$i]->main->image3 . "'" . ",0,'main'" . ")") or die(mysql_error());
                 }
             ...
             {
                 if(empty($imgid4)) {
                     mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES (''," . $prdid . ",'" . "catalog/" . $arr3->product[$i]->main->image4 . "'" . ",0,'main'" . ")") or die(mysql_error());
                 }
             ...
             {
                 if(empty($imgid5)) {
                     mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES (''," . $prdid . ",'" . "catalog/" . $arr3->product[$i]->main->image5 . "'" . ",0,'main'" . ")") or die(mysql_error());
                 }
             ...
             {
                 if(empty($imgid6)) {
                     mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES (''," . $prdid . ",'" . "catalog/" . $arr3->product[$i]->main->image6 . "'" . ",0,'main'" . ")") or die(mysql_error());
                 }
             ...
             {
                 if(empty($imgid7)) {
                     mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES (''," . $prdid . ",'" . "catalog/" . $arr3->product[$i]->main->image7 . "'" . ",0,'main'" . ")") or die(mysql_error());
                 }
             ...
             {
                 if(empty($imgid8)) {
                     mysql_query("INSERT INTO oc_product_image(product_image_id, product_id, image, sort_order, image_type) VALUES (''," . $prdid . ",'" . "catalog/" . $arr3->product[$i]->main->image8 . "'" . ",0,'main'" . ")") or die(mysql_error());
                 }
             ...
             for( $attrq=0;$attrq<count($arr3->product[$i]->attributes->attribute);$attrq++ )
             {
                 ...
                 while($attrow=mysql_fetch_assoc($spisattr))
                 {
                     ...
                     if(!empty($selattr1))
                     {
                         ...
                         if($attrname2==$arr3->product[$i]->attributes->attribute[$attrq]->attrname)
                         {
                             ...
                             $testtext=mysql_query("SELECT text FROM oc_product_attribute WHERE attribute_id=".$selattr1);
                             if($testtext!=$arr3->product[$i]->attributes->attribute[$attrq]->attrvalue)
                             {
                             $updtext=mysql_query("UPDATE oc_product_attribute SET text='".$arr3->product[$i]->attributes->attribute[$attrq]->attrvalue."'"." WHERE attribute_id=".$selattr1);
                             }
                         }
                 ...
                 if($attrflag!=1)
                 {
                     ...
                     $q27="INSERT INTO `oc_attribute_description` (`attribute_id`,`language_id`,`name`) VALUES ($aid,2,"."'".$arr3->product[$i]->attributes->attribute[$attrq]->attrname."'".")";
                     mysql_query($q27) or die(mysql_error());

                     $q3="INSERT INTO `oc_product_attribute` (`product_id`,`attribute_id`,`language_id`,`text`) VALUES($pid,$aid,2,"."'".$arr3->product[$i]->attributes->attribute[$attrq]->attrvalue."'".")";
                     mysql_query($q3) or die(mysql_error());
                 }
                 */
                // $selattr=mysql_fetch_assoc($spisattr);
                // $selattr1=$selattr['attribute_id'];

            /*
           $spisattr=mysql_query("SELECT attribute_id FROM oc_product_attribute WHERE product_id=".$prdid." AND name=".$arr3->product[$i]->attributes->attribute[$attrq]->attrname);
           $selattr=mysql_fetch_assoc($spisattr);
           $selattr1=$selattr['attribute_id'];
           if(!empty($selattr1))
           {
           ...
           while($attrow=mysql_fetch_assoc($spisattr))
           {
               ...
               $attrname=mysql_query("SELECT * FROM oc_attribute_description WHERE attribute_id=".$attrow['attribute_id']);
               $attrname1=mysql_fetch_assoc($attrname);
               $attrname2=$attrname1['name'];
               $attrid=$attrname1['attribute_id'];
               echo $attrid."<br>";
               echo "value".$arr3->product[$i]->attributes->attribute[$attrq]->attrname."==".$attrname2."<br>";
               echo "name".$attrow['text'].'!='.$arr3->product[$i]->attributes->attribute[$attrq]->attrvalue."<br>";
               if($arr3->product[$i]->attributes->attribute[$attrq]->attrname==$attrname2)
               {
                   if($attrow['text']!=$arr3->product[$i]->attributes->attribute[$attrq]->attrvalue)
                   {
                       $updvalue=mysql_query("UPDATE oc_attribute_description SET text='".$arr3->product[$i]->attributes->attribute[$attrq]->attrvalue."'"." WHERE attribute_id=".$attrid );
                   }
               }
               //$arr3->product[$i]->attributes->attribute[$q]->attrname
           }
           */
             }
