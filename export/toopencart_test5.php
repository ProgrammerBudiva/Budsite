...
//atributes
  ...
  //$u1="UPDATE oc_product SET base_price=".$price.", price=".$price.", base_currency_code='".$arr3->product[$i]->data->currency."'"." , quantity=".$quantity." WHERE model = '".$model_u."'";
     ...
     $u1="UPDATE oc_product SET base_price=".$price.", price=".$price.", base_currency_code='".$arr3->product[$i]->data->currency."'"." , quantity=".$quantity." , sku='".$sku_upd."' , image='".$imgpath."'"." WHERE model = '".$model_u."'";
     echo $u1."<br>";
