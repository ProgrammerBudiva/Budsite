        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-gp"><?php echo $entry_gp; ?></label>
                  <div class="col-sm-10">
                      <input type="text" name="config_gp" value="<?php echo $config_gp; ?>" placeholder="<?php echo $entry_gp; ?>" id="input-gp" class="form-control" />
                  </div>
              </div>
              <?php if ($locations) { ?>
              <div class="form-group">
