...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?= $text_confirm; ?>') ? $('#form-news').submit() : false";>
  ...
  <div class="container-fluid">
			  ...
			  <tbody>
				<?php if ($all_news) { ?>
				  ...
				  <tr>
					...
					<td class="text-right">
            <a href="<?= $news['edit'] ?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="<?= $text_edit; ?>">
	...
	<div style="text-align:center; color:#222222;">Advance News System v3.0.1 by <a target="_blank" href="http://www.marketinsg.com">MarketInSG</a></div>
  </div>
</div>
