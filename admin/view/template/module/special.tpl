          ...
          <div class="form-group">
              ...
              <div class="col-sm-10">
                  <select name="type" id="input-type" class="form-control">
                      <?php if ($type) { ?>
                      <option value="1" selected="selected"><?php echo $text_special; ?></option>
                      <option value="0"><?php echo $text_sale; ?></option>
                      <?php } else { ?>
                      <option value="1"><?php echo $text_special; ?></option>
                      <option value="0" selected="selected"><?php echo $text_sale; ?></option>
                      <?php } ?>
                  </select>
              </div>
          </div>
