    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-latest" class="form-horizontal">
          ...
          <div class="form-group">
              <label class="col-sm-2 control-label" for="input-limit-days"><?php echo $entry_limit_days; ?></label>
              <div class="col-sm-10">
                  <input type="text" name="limit_days" value="<?php echo $limit_days; ?>" placeholder="<?php echo $entry_limit_days; ?>" id="input-limit-days" class="form-control" />
              </div>
          </div>
          <div class="form-group">
