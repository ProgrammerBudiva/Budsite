											...
											<div class="release">
												...
												<blockquote>
													...
													<ul>
														...
														<li>admin/view/template/catalog/aqe/product_quick_form2.tpl</li>
														<li>admin/view/template/catalog/aqe/quick_edit_form2.tpl</li>
														<li>admin/view/template/module/admin_quick_edit.tpl</li>
														<li>admin/view/template/sale/aqe/quick_edit_form2.tpl</li>
														<li>system/admin_quick_edit.ocmod.xml</li>
													</ul>
											...
											<div class="release">
												...
												<blockquote>
													...
													<ul>
														...
														<li>admin/view/template/catalog/product_quick_form2.tpl</li>
														<li>admin/view/template/catalog/profile_list_ext.tpl</li>
														<li>admin/view/template/catalog/quick_edit_form2.tpl</li>
													</ul>
												</blockquote>
											</div>
