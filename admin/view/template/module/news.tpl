      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-news" class="form-horizontal">
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-news_dimensions"><?php echo $text_image_dimension; ?></label>
            <div class="col-sm-10">
              <input type="text" name="news_image_width" placeholder="<?php echo $entry_width; ?>" value="<?php echo $news_image_width; ?>"/>
              <input type="text" name="news_image_height" placeholder="<?php echo $entry_height; ?>" value="<?php echo $news_image_height; ?>"/>
