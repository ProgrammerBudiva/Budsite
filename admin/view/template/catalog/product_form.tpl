        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][meta_h1]" rows="5" placeholder="H1" id="input-meta-keyword<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_h1'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-lower_price"><?php echo $entry_lower_price; ?></label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="input-base"><?php echo $entry_base_price; ?></label>
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="input-base" name="base_price" value="<?php echo $base_price; ?>" />
                </div>
                <div class="col-sm-3">
                    <select name="base_currency_code" class="form-control">
                ...
                <table id="images" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="image-row<?php echo $image_row; ?>">
                      ...
                      <td class="text-left">
                        <select name="product_image[<?php echo $image_row; ?>][image_type]" data-toggle="image_type" id="image_type<?php echo $image_row?>">
                          <?php if($product_image['image_type'] == 'main') { ?>
                          <option value="main" selected="selected"><?php echo $entry_type1?></option>
                          <option value="slider"><?php echo $entry_type2?></option>
                          <?php } else { ?>
                          <option value="main" ><?php echo $entry_type1?></option>
                          <option value="slider" selected="selected"><?php echo $entry_type2?></option>
                          <?php } ?>
                        </select>
                      </td>
