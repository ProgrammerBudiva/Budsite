		            ...
		            <tr>
		              ...
		              <td>
		                ...
		                <div class="scrollbox" id="categories">
		                  ...
		                  <label class="level-<?php echo $category['level']; ?>"><?php echo str_repeat('<i>&mdash;</i>', $category['level']); ?><input type="checkbox" name="category_id[<?= $key ?>][category_id]" value="<?php echo $category['category_id']; ?>"<?php echo (in_array($category['category_id'], array_keys($option_categories)) ? ' checked="checked"' : ''); ?> /><?php echo $category['name']; ?></label>
                        <input type="checkbox" name="category_id[<?= $key ?>][open_index]" style="display: none;"
                               value="1" <?= !empty($option_categories[$category['category_id']]['open_index']) ? ' checked="checked"' : '' ?> />
		                  <?php } ?>
		                </div>
