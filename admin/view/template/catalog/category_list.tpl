          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input type="text" name="filter_name" value="<?php echo $filter_name; ?>" placeholder="Наименование" id="input-name" class="form-control" />
              </div>
              <button type="button" id="button-filter" class="btn btn-primary pull-right"><i class="fa fa-search"></i> Фильтр</button>
            </div>
            <!--<div class="col-sm-4">
              <div class="form-group">
  ...
  <script type="text/javascript"><!--
    ...
    $('input[name=\'filter_name\']').autocomplete({
      ...
      'select': function(item) {
        $('input[name=\'filter_name\']').val(item['label2']);
      }
    });
