...
$_['text_edit']    	   = 'Edit Image Crusher';
...
$_['image_crusher_existing_images_image_folder_text']    = 'Enter the path of a folder inside the image directory e.g. catalog/demo';
