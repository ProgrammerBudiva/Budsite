...
$_['entry_lower_price']      = '% условной наценки';
...
$_['entry_sort_order']       = 'Порядок сортировки (ДЛЯ ТЕГОВЫХ КАТЕГОРИЙ порядок должен быть числом более 10000)';
$_['entry_status']           = 'Статус';
$_['entry_layout']           = 'Макет';

$_['entry_type']             = 'Тип категории';
$_['entry_simple']           = 'Стандартная категория';
$_['entry_lookbook']         = 'Lookbook';

// Help
$_['help_filter']            = '(Автозаполнение)';
$_['help_keyword']           = 'Должно быть уникальным на всю систему.';
$_['help_lower_price']       = '% условной наценки для всех товаров в этой категории.';
...
$_['error_lower_price']		   = 'Неверный формат наценки!';
