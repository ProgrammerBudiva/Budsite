...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_type'] = $this->language->get('entry_type');
		$data['entry_type1'] = $this->language->get('entry_type1');
		$data['entry_type2'] = $this->language->get('entry_type2');
		...
		if (isset($this->request->post['lower_price'])) {
			...
			$data['lower_price'] = $product_info['lower_price'];
		} else {
			$data['lower_price'] = '';
		}
  ...
  public function clearMetaTitle(){
    $this->load->model('catalog/product');
    if ($this->model_catalog_product->clearMetaTitle()){
      echo 'success';
    } else {
      echo 'error';
    }
