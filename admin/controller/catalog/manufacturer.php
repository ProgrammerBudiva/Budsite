...
class ControllerCatalogManufacturer extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['name'])) {
	        ...
	        if(isset($this->request->get['manufacturer_id'])) $description = $this->model_catalog_manufacturer->getManufacturerDescriptions($this->request->get['manufacturer_id']);

        //var_dump($description);

	        foreach ($data['languages'] as $key => $value) {
		        if (isset($this->request->post['description'])) {
		            $data['manufacturer_description'][$value['language_id']]['description'] = $this->request->post['description'];
		        } elseif (!empty($manufacturer_info)) {
		            $data['manufacturer_description'][$value['language_id']]['description'] = $description[$value['language_id']]['description'];
		        } else {
		            $data['manufacturer_description'][$value['language_id']]['description'] = array();
		        }

		        if (isset($this->request->post['meta_description'])) {
		            $data['manufacturer_description'][$value['language_id']]['meta_description'] = $this->request->post['meta_description'];
		        } elseif (!empty($manufacturer_info)) {
		            $data['manufacturer_description'][$value['language_id']]['meta_description'] = $description[$value['language_id']]['meta_description'];
		        } else {
		            $data['manufacturer_description'][$value['language_id']]['meta_description'] = array();
		        }

		        if (isset($this->request->post['meta_title'])) {
		            $data['manufacturer_description'][$value['language_id']]['meta_title'] = $this->request->post['meta_title'];
		        } elseif (!empty($manufacturer_info)) {
		            $data['manufacturer_description'][$value['language_id']]['meta_title'] = $description[$value['language_id']]['meta_title'];
		        } else {
		            $data['manufacturer_description'][$value['language_id']]['meta_title'] = array();
		        }

                if (isset($this->request->post['heading_title'])) {
                    $data['manufacturer_description'][$value['language_id']]['heading_title'] = $this->request->post['heading_title'];
                } elseif (!empty($manufacturer_info)) {
                    $data['manufacturer_description'][$value['language_id']]['heading_title'] = $description[$value['language_id']]['heading_title'];
                } else {
                    $data['manufacturer_description'][$value['language_id']]['heading_title'] = array();
                }
	        }
