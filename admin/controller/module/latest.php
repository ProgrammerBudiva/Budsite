...
class ControllerModuleLatest extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_setting_setting->editSetting('latest', array('latest_limit_days' => $this->request->post['limit_days']));
		...
		$data['entry_limit_days'] = $this->language->get('entry_limit_days');
        ...
        if (isset($this->request->post['limit_days'])) {
            $data['limit_days'] = $this->request->post['limit_days'];
        } elseif (!empty($module_info)) {
            $data['limit_days'] = $module_info['limit_days'];
        } else {
            $data['limit_days'] = 4;
        }
