...
class ControllerCommonHeader extends Controller {
	public function index() {
        ...
        $this->document->addScript('//cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/js/select2.min.js');
        $this->document->addStyle('//cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/css/select2.min.css');
