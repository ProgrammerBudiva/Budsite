...
class ControllerSaleNewssubscribers extends Controller {
	...
	private function getList() {
		...
		$email_total = $this->model_sale_newssubscribers->getTotalEmails($e_data);
		
		$results = $this->model_sale_newssubscribers->getEmails($e_data,($page - 1) * $this->config->get('config_admin_limit'),$this->config->get('config_admin_limit'));
