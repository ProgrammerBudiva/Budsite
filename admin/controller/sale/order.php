...
class ControllerSaleOrder extends Controller {
	...
	public function getForm() {
		...
		if (!empty($order_info)) {
			...
			$data['payment_firstname'] = $order_info['payment_firstname'] ? $order_info['payment_firstname'] : $order_info['firstname'];
			$data['payment_lastname'] = $order_info['payment_lastname'] ? $order_info['payment_lastname'] : $order_info['lastname'];
			...
			$data['shipping_firstname'] = $order_info['shipping_firstname'] ? $order_info['shipping_firstname'] : $order_info['firstname'];
			$data['shipping_lastname'] = $order_info['shipping_lastname'] ? $order_info['shipping_lastname'] : $order_info['lastname'];
