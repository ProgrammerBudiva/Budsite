...
class ControllerProductManufacturer extends Controller {
	...
	public function info() {
		...
		if ($manufacturer_info) {
			...
			$data['heading_title'] = $manufacturerdesc_info['heading_title'] ? $manufacturerdesc_info['heading_title'] : $manufacturer_info['name'];
			$data['seo_description'] = htmlspecialchars_decode($manufacturerdesc_info['description']);
