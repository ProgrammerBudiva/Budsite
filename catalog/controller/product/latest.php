...
class ControllerProductLatest extends Controller {
	public function index() {
        ...
        if (isset($this->request->get['latest_id'])) {
            $url .= '&latest_id=' . $this->request->get['latest_id'];
        }
        ...
        if(isset($this->request->get['latest_id'])){
            $filter_data = array(
                ...
                'start' => ($page - 1) * $limit,
                'limit' => $limit,
                'filter_category_id' => $this->request->get['latest_id'],
            );
        }
        ...
        if (isset($this->request->get['latest_id'])) {
            $url .= '&path=' . $this->request->get['latest_id'];
        }

        if(isset($this->request->get['latest_id'])){
            $category_id = $this->request->get['latest_id'];
        } else {
            $category_id = false;
        }

		$product_total = $this->model_catalog_product->getTotalProductLatest($limit_days, $category_id);
