...
class ControllerFeedRozetka extends Controller
{
    ...
    public function createXML($array, $cat_226){
        ...
        foreach ($array['products'] as $product_self){
            ...
            $text = mb_str_replace("Чтобы купить необходимое количество , заполните онлайн-заявку. Также не забывайте следить за выгодными предложениями и новостями проекта.", '', $text);
