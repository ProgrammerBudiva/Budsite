...
class ControllerModuleSpecial extends Controller {
	public function index($setting) {
        ...
        $type = ($setting['type'])?'special':'sale';
        $priority = ($setting['type'])?'1':'2';
        $data['text_more'] = $this->language->get('text_more');

		$data['heading_title'] = $this->language->get('heading_title_'.$type);
        ...
        $data['percent'] = ($setting['type'])?'40':'70';
		...
		$results = $this->model_catalog_product->getProductSpecials($filter_data, $priority);
