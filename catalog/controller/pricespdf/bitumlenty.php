...
class ControllerPricespdfBitumlenty extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 578 ];
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/skatnaya/bitumlenty.pdf', $dompdf->output());
        exit(0);
    }
}