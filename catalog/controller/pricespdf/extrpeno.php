 ...
 * Time: 14:36
 */
class ControllerPricespdfExtrpeno extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 271 ];
         ...
         <div class="main1">
            <table class="table  table-bordered">
                <tr class="active">
                    ...
                    <td width="11%">Фото</td>
                    <td>Название</td>
                    <td width="10%">Площадь в упаковке, м.кв.</td>
                    <td width="10%">Плотность, кг/м.куб.</td>
                    <td width="10%">Толщина, мм</td>
                    <td width="">Группа горючести</td>
...
//echo "<pre>"; print_r($attrs); echo "</pre>";die;
            ...
            <tr class="">
                ...
                <td width="10%">' . $attr_valid[17] . '</td>
                <td width="10%">' . $width . '</td>
                <td width="">' . $attr_valid[7] . '</td>
...
//        $output = $dompdf->output();
        file_put_contents('gen_prices/extrpeno.pdf', $dompdf->output());
        exit(0);
    }
}