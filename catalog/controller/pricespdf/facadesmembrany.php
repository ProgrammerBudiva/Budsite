...
class ControllerPricespdfFacadesmembrany extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 250 ];
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/facades/facadesmembrany.pdf', $dompdf->output());
        exit(0);
    }
}