...
class ControllerPricespdfShlangi extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 325 ];
         ...
         <div class="main1">
            <table class="table  table-bordered">
                <tr class="active">
                    ...
                    <td width="11%">Фото</td>
                    <td width="16%">Название</td>
                    <td width="10%">Бренд</td>
                    <td width="10%">Вид</td>
                    <td width="7%">Длина, м.</td>
                    <td width="10%">Применение</td>
                    <td width="10%">Количество слоев</td>
                    <td width="8%">Цена</td>
                </tr>
        </table></div>
...
//            echo "<pre>"; print_r($attrs); echo "</pre>";die;
            ...
            <tr class="">
                ...
                <td width="16%"> <a href="https://budsite.ua/'. $query->row['keyword'] .'">'. $product['name'] . '</td>

                <td width="10%">' .$attr_valid[2]. '</td>
                <td width="10%">' .$attr_valid[31]. '</td>
                <td width="7%">' .$attr_valid[38]. '</td>
                <td width="10%">' .$attr_valid[3]. '</td>
                <td width="10%">' .$attr_valid[24]. '</td>
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/poliv/shlangi.pdf', $dompdf->output());
        exit(0);
    }
}