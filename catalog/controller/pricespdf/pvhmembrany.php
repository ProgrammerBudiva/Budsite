...
class ControllerPricespdfPvhmembrany extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 216 ];
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/gidroizolyaciya/pvh_membrany.pdf', $dompdf->output());
        exit(0);
    }
}