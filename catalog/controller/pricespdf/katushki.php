...
class ControllerPricespdfKatushki extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 506 ];
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/poliv/katushki.pdf', $dompdf->output());
        exit(0);
    }
}