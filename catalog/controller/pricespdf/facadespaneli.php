...
class ControllerPricespdfFacadespaneli extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 210 ];
         ...
         <div class="main1">
            <table class="table  table-bordered">
                <tr class="active">
                    ...
                    <td width="10%">Форма</td>
                    <td width="10%">Цвет</td>
                    <td width="10%">Коллекция</td>
...
//            echo "<pre>"; print_r($attrs); echo "</pre>";die;
            ...
            $shape = isset($attr_valid[36]) ?$attr_valid[36] : '-';
            $color = isset($attr_valid[5]) ?$attr_valid[5] : '-';
            $collection = isset($attr_valid[25]) ?$attr_valid[25] : '-';
            $test .= '
            <tr class="">
                ...
                <td width="10%">' . $shape . '</td>
                <td width="10%">' . $color . '</td>
                <td width="10%">' . $collection . '</td>
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/facades/facadespaneli.pdf', $dompdf->output());
        exit(0);
    }
}