...
class ControllerPricespdfVodosyst extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 200 ];
         ...
         <div class="main1">
            <table class="table  table-bordered">
                <tr class="active">
                    ...
                    <td width="10%">Цвет</td>
                    <td width="10%">Типоразмер системы</td>
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/skatnaya/vodosyst.pdf', $dompdf->output());
        exit(0);
    }
}