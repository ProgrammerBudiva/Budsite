...
class ControllerPricespdfShlangikap extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 509 ];
...
//            echo "<pre>"; print_r($attrs); echo "</pre>";die;
            ...
            $length = isset($attr_valid[38])?$attr_valid[38]:'-';
            $test .= '
            <tr class="">
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/poliv/shlangikap.pdf', $dompdf->output());
        exit(0);
    }
}