...
class ControllerPricespdfLestnicy extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 226 ];
         ...
         <div class="main1">
            <table class="table  table-bordered">
                <tr class="active">
                    ...
                    <td width="7%">Бренд</td>
                    <td width="11%">Тип открывания</td>
                    <td width="7%">Размер люка</td>
                    <td width="11%">Максимальная высота</td>
...
//            echo "<pre>"; print_r($attrs); echo "</pre>";die;
            ...
            <tr class="">
                ...
                <td width="11%">' . $attr_valid[15] . '</td>
                <td width="7%">' . $attr_valid[14] . '</td>
                <td width="11%">' . $attr_valid[12] . '</td>
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/skatnaya/lestnicy.pdf', $dompdf->output());
        exit(0);
    }
}