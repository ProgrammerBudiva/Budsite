...
class ControllerPricespdfCaydingvoxmax extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 212 ];
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/facades/caydingvoxmax.pdf', $dompdf->output());
        exit(0);
    }
}