...
class ControllerPricespdfBitumkatepal extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 251 ];
         ...
         <div class="main1">
            <table class="table  table-bordered">
                <tr class="active">
                    ...
                    <td width="10%">Цвет</td>
                    <td width="10%">Гарантия, лет</td>
                    <td width="9%">Вес, кг/м.кв.</td>
                    <td width="9%">Количество слоев</td>
                    <td width="9%">Коллекция</td>
...
//            echo "<pre>"; print_r($product); echo "</pre>";die;
            ...
            <tr class="">
                ...
                <td width="10%">' . $attr_valid[5] . '</td>
                <td width="10%">' . $attr_valid[6] . '</td>
                <td width="9%">' . $attr_valid[20] . '</td>
                <td width="9%">' . $attr_valid[24] . '</td>
                <td width="9%">' . $attr_valid[25] . '</td>
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/bitumnaya/katepal.pdf', $dompdf->output());
        exit(0);
    }
}