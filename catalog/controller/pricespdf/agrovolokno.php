...
class ControllerPricespdfAgrovolokno extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 406 ];
         ...
         <div class="main1">
            <table class="table  table-bordered">
                <tr class="active">
                    ...
                    <td width="10%">Цвет</td>
                    <td width="10%">Плотность, г/м.кв.</td>
                    <td width="10%">Ширина, м</td>
...
//            echo "<pre>"; print_r($attrs); echo "</pre>";die;
            ...
            <tr class="">
                ...
                <td width="10%">' . $attr_valid[16] . '</td>
                <td width="10%">' . $attr_valid[39] . '</td>
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/sad/agrovolokno.pdf', $dompdf->output());
        exit(0);
    }
}