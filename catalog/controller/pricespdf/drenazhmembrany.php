...
class ControllerPricespdfDrenazhmembrany extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 458 ];
         ...
         <div class="main1">
            <table class="table  table-bordered">
                <tr class="active">
                    ...
                    <td width="10%">Плотность, г/кв.м.</td>
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/drenazh/drenazhmembrany.pdf', $dompdf->output());
        exit(0);
    }
}