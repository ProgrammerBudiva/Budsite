...
class ControllerPricespdfOtsgidro extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 299 ];
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/gidroizolyaciya/otsgidro.pdf', $dompdf->output());
        exit(0);
    }
}