...
class ControllerPricespdfFitingi extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 324 ];
         ...
         <div class="main1">
            <table class="table  table-bordered">
                <tr class="active">
                    ...
                    <td width="10%">Вид</td>
                    <td width="10%">Диаметр в дюймах</td>
...
//            echo "<pre>"; print_r($attrs); echo "</pre>";die;
            ...
            $type = isset($attr_valid[31])?$attr_valid[31]:'-';
            $diameter = isset($attr_valid[131])?$attr_valid[131]:'-';
            $test .= '
            <tr class="">
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/poliv/fitingi.pdf', $dompdf->output());
        exit(0);
    }
}