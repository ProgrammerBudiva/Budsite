...
class ControllerPricespdfPraimery extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 463 ];
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/gidroizolyaciya/praimery.pdf', $dompdf->output());
        exit(0);
    }
}