...
class ControllerPricespdfKomplploskkrovlja extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 240 ];
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/ploskaya_krovlya/kompl.pdf', $dompdf->output());
        exit(0);
    }
}