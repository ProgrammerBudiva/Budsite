...
class ControllerPricespdfMembrany extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 203 ];
         ...
         <div class="main1">
            <table class="table  table-bordered">
                <tr class="active">
                    ...
                    <td width="9%">Бренд</td>
                    <td width="9%">Плотность, г/м.кв.</td>
...
//            echo "<pre>"; print_r($attrs); echo "</pre>";die;
            ...
            <tr class="">
                ...
                <td width="11%"><img style="max-width: 100%; height: 160px; text-align: center;" align="center"  src="image/' . $product['image'] . '"></td>
                <td width="20%"> <a href="https://budsite.ua/'. $query->row['keyword'] .'">'. $product['name'] . '</td>


                <td width="9%">' . $attr_valid[2] . '</td>
                <td width="9%">' . $attr_valid[16] . '</td>
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/skatnaya/membrany.pdf', $dompdf->output());
        exit(0);
    }
}