...
class ControllerPricespdfKrovljhapvh extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 207 ];
         ...
         <div class="main1">
            <table class="table  table-bordered">
                <tr class="active">
                    ...
                    <td width="10%">Размер рулона</td>
                    <td width="9%">Толщина, мм</td>
                    <td width="9%">Группа горючести</td>
...
//            echo "<pre>"; print_r($attrs); echo "</pre>";
            ...
            $fire_group = isset($attr_valid[7])? $attr_valid[7]: '-';
            $test .= '
            <tr class="">
                ...
                <td width="10%">' . $attr_valid[8] . '</td>
                <td width="9%">' . $attr_valid[9] . '</td>
                <td width="9%">' . $fire_group . '</td>
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/ploskaya_krovlya/pvhmembrany.pdf', $dompdf->output());
        exit(0);
    }
}