...
class ControllerPricespdfDozhdevateli extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 507 ];
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/poliv/dozhdevateli.pdf', $dompdf->output());
        exit(0);
    }
}