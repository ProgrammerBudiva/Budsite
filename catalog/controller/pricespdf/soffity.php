...
class ControllerPricespdfSoffity extends Controller
{
    public function index()
    {
        $data = ['filter_category_id' => 204 ];
...
//        $dompdf->stream("dompdf_out.pdf", array("Attachment" => false));
        file_put_contents('gen_prices/skatnaya/soffity.pdf', $dompdf->output());
        exit(0);
    }
}