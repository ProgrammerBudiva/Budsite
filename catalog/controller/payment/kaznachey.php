...
class ControllerPaymentKaznachey extends Controller {
	...
	public function index() {
 	...
 	public function callback() {
        ...
        $this->model_module_shoputils_mail_order_status->confirmOrder((int) $request["MerchantInternalPaymentId"], 1);
        $this->model_module_shoputils_mail_order_status->confirmOrderAdmin((int) $request["MerchantInternalPaymentId"], 1);
