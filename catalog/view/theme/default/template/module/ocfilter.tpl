...
<div class="visible-xs" id="ocfilter-mobile">
  <nav class="navbar navbar-default">
    <div class="navbar-header">
      ...
      <button data-target="#ocfilter" data-toggle="collapse" class="btn btn-navbar navbar-toggle" type="button"><i class="fa fa-bars"></i></button>
    </div>
  ...
  <div class="list-group" id="ocfilter-content">
      ...
      <?php } ?>
            ...
            <div class="collapse" id="ocfilter-hidden-values-<?php echo $option['option_id']; ?>">
                ...
                <?php if (!$option['open_index']) { ?>
                  <span data-href="<?php echo $value['href']; ?>"><?php echo $value['name']; ?></span>
                <?php } else { ?>
