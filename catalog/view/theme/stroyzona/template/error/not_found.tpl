  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="err404-description">
        <p>Что-то пошло не так. Возможно, эта страница была удалена либо допущена ошибка в адресе.</p>
        <p><a href="contact-us"><u>Напишите, что вас интересует</u></a>, и мы предоставим всю нужную информацию, или <a href="/">
            <span class="err404-button">перейдите на главную</span></a>.</p>
      </div>
