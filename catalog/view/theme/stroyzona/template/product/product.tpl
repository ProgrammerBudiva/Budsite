                ...
                <div class="<?php echo $class; ?>">
                    ...
                    <div class="shares-to-frends">
                        ...
                        <div class="yashare-auto-init" data-yashareL10n="ru" data-yashareType="none"
                             {*data-yashareQuickServices="facebook,vkontakte,gplus"></div>*}
                            ...
                            <div class="delivery-pay-popup">
                                ...
                                <ul>
                                    <li>Курьерскими службами:</li>
                                        ...
                                        <img width="100" alt="Доставка строительных материалов Новой Почтой" src="/image/catalog/Info/new_post.png">
                                        <img width="100" alt="Купить стройматериалы с доставкой Интайм" src="/image/catalog/Info/intime.png">
                                        <img width="100" alt="Стройматериалы с доставкой Деливери по Украине" src="/image/catalog/Info/delivery2.png">
                                        <img width="100" alt="Интернет магазин строительных и отделочных материалов с доставкой Мист-экспресс" src="/image/catalog/Info/meest.png">
                                <ul>
                                    <li>Курьерская доставка по Киеву, Одессе, Днепропетровску.</li>
                                    <li>Самовывоз.</li>
                                    <li>Стоимость доставки зависит от объемов заказанного товара.</li>
                                </ul>
                                <h4><b>Способы оплаты:</b></h4>
                                <ul>
                                    <li>Наличный расчет (при получении, только г. Одесса).</li>
                                    <li>Безналичный расчет (предоплата, счет действителен к оплате в течении одного дня.)</li>
                                    <li>Наложенный платеж (наличными курьеру, при получении).</li>
                                </ul>
