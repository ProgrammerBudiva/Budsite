    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <table class="table table-bordered table-hover">
        ...
        <tr>
          ...
          <td class="text-right"><a href="<?php echo $result['update']; ?>" class="btn btn-primary"><?php echo $button_edit; ?></a> &nbsp; <a href="<?php echo $result['delete']; ?>" class="btn btn-danger account-danger"><?php echo $button_delete; ?></a></td>
        </tr>
        <?php } ?>
      </table>
      <?php } else { ?>
