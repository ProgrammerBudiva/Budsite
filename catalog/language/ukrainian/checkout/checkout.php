...
$_['text_register_account'] =
  'Після створення профілю Ви зможете робити покупки швидше, відслідковувати статус замовлення і зберігати історію попередніх замовлень.';
...
$_['entry_fax'] = 'Факс';
$_['entry_address'] = 'Вул, дім, квартира';
...
$_['entry_city'] = 'Місто';
$_['entry_forgotten'] = 'Забули пароль?';
...
// Error
$_['error_warning'] =
  'В процесі обробки Вашого замовлення виникли проблеми! Якщо проблеми не зникнуть попробуйте обрати інший метод оплати або пишіть у <a href="%s">службу пітримки</a>.';
...
$_['error_firstname'] = 'ПІБ повинно містити від 5 до 64 символів!';
...
$_['error_city'] = 'Виберіть місто з випадаючого списку!';
...
$_['entry_price'] = 'Ціна';
$_['entry_choose'] = 'Виберіть';
$_['entry_contacts'] = 'Контактні дані';
$_['entry_payment_method'] = 'Спосіб оплати та доставки';
$_['entry_payment'] = 'Способ оплати';
$_['entry_order'] = 'Склад замовлення';
$_['entry_self'] = 'Самовивіз';
$_['entry_courier'] = 'Кур’єром';
$_['entry_delivery_address'] = 'Відділення Нової Пошти';
$_['entry_country'] = 'Країна';
$_['entry_street'] = 'Вулиця';
$_['entry_house'] = 'Дім';
$_['entry_new_post'] = 'Способ доставки';
