...
$_['entry_forgotten'] = 'Забыли пароль?';
$_['button_login'] = 'Войти';
$_['button_continue'] = 'Оформить мой заказ';
...
$_['text_day'] = 'день';
$_['text_week'] = 'неделю';
$_['text_total_discount'] = 'Общая Скидка';
...
$_['error_warning'] =
  'Возникла проблема при обработке Вашего заказа! Если проблема возникает повторно, попробуйте выбрать другой способ оплаты или <a href="%s">свяжитесь с администратором магазина</a>.';
...
$_['error_firstname'] = 'Имя должно быть от 5 до 64 символов!';

$_['error_lastname'] = 'Фамилия должна быть от 5 до 32 символов!';

$_['error_email'] = 'Е-mail адрес введён неверно!';

$_['error_telephone'] = 'Номер телефона должен соответствовать маске!';
...
$_['entry_contacts'] = 'Контактные данные';
$_['entry_payment_method'] = 'Способ оплаты и доставки';
$_['entry_payment'] = 'Способ оплаты';
$_['entry_order'] = 'Заказ';
$_['entry_self'] = 'Самовывоз';
$_['entry_courier'] = 'Курьером';
$_['entry_delivery_address'] = 'Отделение Новой Почты';
$_['entry_country'] = 'Страна';
