...
$_['text_your_details']    = 'Основне данные';
...
$_['thanks_for_register']  = 'Спасибо за регистрацию';
$_['thanks_for_register_text']  = 'На ваш E-Mail отправлены инструкции';
$_['text_message_social']   = 'Регистрация в два клика';
...
$_['entry_necessarily']      = 'Обязательные данные';
...
$_['remember_me'] = 'Запомнить меня';

$_['is_robot'] = 'Я не робот';
$_['entry_captcha'] = 'Введите капчу';
$_['error_captcha'] = 'Неверный ввод капчи';

$_['entry_confirm']        = 'Подтверждение пароля';

$_['entry_necessarily']        = 'Поля, обязательные для заполнения';
