...
$_['text_guest']     = '<p>Наш менеджер ответит на него </br> или свяжется по указанному номеру в рабочее время<br/>(пн.-пт. с 9:00-18:00) в течении 15 минут.</p><p>Если у Вас возник срочный вопрос, позвоните по </br>номеру (044) 390-20-40</p><p>Спасибо за доверие к интернет-магазину budsite!</p>';
$_['heading_title_message']        = 'Спасибо. </br> Ваше сообщение отправлено!';
